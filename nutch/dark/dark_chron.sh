...
do
  ...
  java -cp target/nutch-tika-solr-1.0-SNAPSHOT.jar edu.usc.cs.ir.cwork.files.DarkDumpPoster -nutch /usr/local/memex/darkWeapons/dark_Cron_production/nutch/runtime/local -solr http://localhost:8983/solr/imagecatdev -timeout 70000 -list /usr/local/memex/darkWeapons/dark_Cron_production/updates/$updates
done
echo "JOB COMPLETE"